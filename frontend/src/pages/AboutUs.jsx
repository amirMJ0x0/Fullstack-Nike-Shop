    ...
    <>
      ...
      <div className="padding-x h-screen space-y-5">
        ...
        <p>
          ...
          dedicated to inspiring athletes of all levels to achieve their best.
        ...
        <p>
          ...
          We are committed to creating sustainable products, fostering
          inclusivity, and empowering communities through our initiatives.
        </p>
        <p>
