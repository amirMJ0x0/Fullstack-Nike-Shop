...
export const fetchUserInfo = async () => {
    try {
        const res = await axiosInstance.get(`/api/auth/userInfo`);
        return res.data;
    } catch (error) {
...
export const toggleSaveProduct = async (productId) => {
    try {
        const res = await axiosInstance.post(`/api/users/save-product`, { productId });
        return res.data;
    } catch (error) {
...
export const getSavedProducts = async () => {
    try {
        const res = await axiosInstance.get(`/api/users/saved-products`);
        return res.data;
    } catch (error) {
